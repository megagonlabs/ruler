    ...
    return (
      <Paper className={classes.paper}>
        ...
        <Typography variant="body1">
          Your labeling functions are agreggated by snorkel's labeling model
          then evaluated on the labeled development set. More information about
          these metrics is available via{" "}
          <a href="https://scikit-learn.org/stable/modules/model_evaluation.html#classification-metrics">
            Scikit-Learn
          </a>
          .
        </Typography>
