...
class Navigation extends React.Component {
    ...
    clickNext() {
        ...
        if (this.state.queued_interactions.length === 0) {
            ...
            this.props.setAsCurrentInteraction(
                this.state.queued_interactions.pop()
            );
        }
    ...
    render() {
        ...
        const FabText =
            this.props.currentLabel === null && this.props.text.length !== 0
                ? "Skip"
                : "Next";
        ...
        return (
            <NavigationButtons
                ...
                clickPrevious={
                    this.props.index > 0 ? this.clickPrevious.bind(this) : null
                }
            />
        );
    }
...
function mapDispatchToProps(dispatch) {
    return {
        ...
        setAsCurrentInteraction: bindActionCreators(
            setAsCurrentInteraction,
            dispatch
        ),
    };
}
